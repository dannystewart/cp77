module CustomQuickslotsResolutionListener

// Credit to psiberx for this great solution for resizing a widget based on resolution change
// Most widgets have this done automatically because they are a child of an inkVirtualWindow which handles this
// For this mod I had to remove the hotkeys from the bottom-left virtual window because it was clipping some of the hotkeys
