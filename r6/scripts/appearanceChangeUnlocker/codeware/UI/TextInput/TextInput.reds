// -----------------------------------------------------------------------------
// AppearanceUnlocker.Codeware.UI.TextInput [WIP]
// -----------------------------------------------------------------------------
//
// Controls:
...
public class TextInput extends inkCustomController {
	...
	protected func UnregisterListeners() -> Void {
		...
		this.UnregisterFromCallback(n"OnFocusReceived", this.m_root, n"OnFocusReceived");
		this.UnregisterFromGlobalInputCallback(n"OnFocusLost", this.m_root, n"OnFocusLost");

		//this.RegisterToCallback(n"OnPress", this, n"OnPressKey");
		this.UnregisterFromCallback(n"OnRelease", this, n"OnReleaseKey");
		this.UnregisterFromCallback(n"OnCharacterKey", this, n"OnCharacterKey");

		this.m_measurer.UnregisterFromCallback(n"OnTextMeasured", this, n"OnTextMeasured");
		this.m_measurer.UnregisterFromCallback(n"OnCharMeasured", this, n"OnTextMeasured");
	}
